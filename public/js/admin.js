...
function sidebarColor(a) {
  var parent = a.parentElement.parentElement.querySelectorAll('.nav-link');
  var color = a.getAttribute("data-color");

  // Hapus class 'active' dari semua elemen menu
  parent.forEach(function (element) {
    element.classList.remove('active');
  });

  // Tambahkan class 'active' ke elemen menu yang diklik jika tidak ada, atau hapus jika sudah ada
  ...
  // Ganti atribut 'data-color' pada elemen sidebar
  var sidebar = document.querySelector('.sidenav');
  sidebar.setAttribute("data-color", color);

  // Periksa apakah ada elemen dengan id 'sidenavCard'
  if (document.querySelector('#sidenavCard')) {
    var sidenavCard = document.querySelector('#sidenavCard');
    var sidenavCardClasses = ['btn', 'btn-sm', 'w-100', 'mb-0', 'bg-gradient-' + color];

    // Hapus semua class yang ada pada elemen '#sidenavCard'
    sidenavCard.className = '';

    // Tambahkan class yang sesuai
    sidenavCardClasses.forEach(function (cls) {
      sidenavCard.classList.add(cls);
    });
  }
}
